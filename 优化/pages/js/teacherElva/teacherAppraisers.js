$(function(){
	var settingAppraisers = new Vue({
      ...
      addperson: function () {
          ...
          if (name == null) {
              ...
              $.ajax({
                  type: "POST",
                  url: baseURL + '/teacherAssessorAdd',
      ...
      delete:function(id){
        ...
        layer.confirm('确定删除?',function(){
             $.ajax({
                type: "DELETE",
                url: baseURL + '/teacherAssessorDel/' + id,
                success: function(data) {
                  ajaxAssessorList();
                  // 友好提示
                  layer.alert('删除成功',{
      ...
      task:function(id){
          ...
          $.getJSON(baseURL + '/getTeacherAssessor/' + id, function(res){
      ...
      sub:function(){
        ...
        $.ajax({
          type:"POST",
          url: baseURL + '/teacherAssessorEdit',
          data:{
    ...
    function ajaxAssessorList() {
        ...
        $.ajax({
            type: "GET",
            url: baseURL + '/teacherAssessorList',
            success: function(data) {
                // 获取已添加的教师
    ...
    // 选择本校教师全部选中
    $("#checkAllTrue").bind("click", { type: "checkAllTrue" ,obj:"treeType"}, checkNode);
    $("#checkAllFalse").bind("click", { type: "checkAllFalse",obj:"treeType"}, checkNode);
    // $("#checkAllTrue1").bind("click", { type: "checkAllTrue",obj:"tree1"}, checkNode);
    // $("#checkAllFalse1").bind("click", { type: "checkAllFalse",obj:"tree1"}, checkNode);
